...
const styles = {
  card: { background: 'white', border: '1px solid #e8e8e8', borderRadius: 6, padding: 20, marginBottom: 20 },
  ...
  btnSm: { background: '#f0f0f0', border: 'none', borderRadius: 4, padding: '5px 10px', fontSize: 11, cursor: 'pointer' },
  ...
  modal: { background: 'white', borderRadius: 8, padding: 28, width: '100%', maxWidth: 600, boxShadow: '0 8px 32px rgba(0,0,0,0.2)' },
};
