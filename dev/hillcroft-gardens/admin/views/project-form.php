...
<div class="wrap hgd-wrap">
	...
	<?php if ( $is_edit ) :
		...
		<p class="hgd-muted"><?php esc_html_e( 'Existing conditions and the digitised plan now live on the “Plan” step of the wizard — the old editor here has been replaced.', 'hillcroft-garden-designer' ); ?></p>
