 ...
 *
 * Entries are appended to a custom table `{$wpdb->prefix}adf_audit_log`
 * (prefixed `adf_` per §10). Used for approvals, refunds, auto-approve events
...
final class AuditLog {
    ...
    public static function table(): string {
        global $wpdb;
        return $wpdb->prefix . 'adf_audit_log';
    }
