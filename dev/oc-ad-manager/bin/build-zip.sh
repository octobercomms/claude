...
#
# Produces: <out>/oc-ad-manager-<version>.zip
#
# The zip's top-level folder is the WordPress plugin slug (oc-ad-manager),
# which is what WordPress installs.
#
# Usage: bin/build-zip.sh [output_dir]
set -euo pipefail

PLUGIN_SLUG="oc-ad-manager"
