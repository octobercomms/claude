...
const styles = {
  ...
  table: { width: '100%', borderCollapse: 'collapse', background: '#fff', border: '1px solid #eee', borderRadius: 4 },
  ...
  clientList: { border: '1px solid #ddd', borderRadius: 4, maxHeight: 200, overflowY: 'auto', padding: 4, background: '#fafafa' },
