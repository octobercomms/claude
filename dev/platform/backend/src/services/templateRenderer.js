...
async function resolveTemplate({ template, client, period, periodStart, periodEnd, rawData, rawDataPrev, rawDataByPeriod, seoData, chatHistory = [], narrativeCache, fxRates }) {
  const resolved = [];
  for (const section of template.sections) {
    try {
      const r = await resolveSection(section, { client, period, periodStart, periodEnd, rawData, rawDataPrev, rawDataByPeriod, seoData, chatHistory, narrativeCache, fxRates });
...
function resolveMetricsGrid(section, { rawData, rawDataPrev, rawDataByPeriod, periodStart, periodEnd, fxRates }) {
  const result = tpl.resolveMetricsGrid(section, rawData, rawDataPrev, { rawDataByPeriod, periodStart, periodEnd, fxRates });
