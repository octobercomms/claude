...
final class TicketTypes {
    ...
    public const META_TYPES      = '_adf_ticket_types';
    public const META_SALE_UNTIL = '_adf_tickets_sale_until';
    public const META_VENUES     = '_adf_checkin_venues';
    public const META_PIN        = '_adf_checkin_pin';
