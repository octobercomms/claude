...
const styles = {
  ...
  toggle: { padding: '6px 14px', fontSize: 12, fontWeight: 600, border: '1px solid #ddd', background: '#fff', color: '#555', cursor: 'pointer', borderRadius: 999 },
  ...
  input: { padding: '5px 8px', fontSize: 12, border: '1px solid #ddd', borderRadius: 4, fontFamily: 'inherit' },
  ...
  iframe: { flex: 1, background: '#fff', border: '1px solid #ddd', borderRadius: 4, width: '100%', height: '100%' },
