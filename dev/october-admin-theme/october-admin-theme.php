 ...
 * Description: Makes the WordPress admin calm and Squarespace-simple — a monochrome black/white/grey skin with underline accents, generous whitespace, a short sidebar that tucks technical clutter into a collapsible "Advanced" section, a stripped-back toolbar, and the classic editor (no Gutenberg). Fast: one small stylesheet, one tiny script, system fonts, no external requests.
 * Version:     2.1.0
...
define( 'OCTOBER_THEME_VERSION', '2.1.0' );
