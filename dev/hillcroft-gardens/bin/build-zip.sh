...
#
# Produces: <out>/hillcroft-garden-designer-<version>.zip
#
# Note: the repo app folder is `dev/hillcroft-gardens/` (matches docs/), but the
# WordPress plugin slug is `hillcroft-garden-designer` (its main file / text
...
PLUGIN_SLUG="hillcroft-garden-designer"
