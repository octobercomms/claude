...
#
# Produces: <out>/october-events-<version>.zip
#
# The repo app folder is `dev/october-events/` (matches docs/), but the WordPress
# plugin slug is `october-events` (its main file / what WP installs and what
...
PLUGIN_SLUG="october-events"
MAIN_FILE="october-events.php"
