...
class YAA_Archie {
	...
	private static function system_prompt( array $state = array() ) {
		...
		$lines = array(
			...
			'',
			'FINISHING — IMPORTANT: once you have a valid email (and their name), nothing is actually sent to us until the person presses the button. So your final message must NOT say the project is submitted, sent, or that the team will be in touch yet. Instead, warmly tell them their fixed-price quote is ready and ask them to press the orange "Save & submit project" button on the right to send it to our team and get their quote by email. Do not mention the price.',
			'',
