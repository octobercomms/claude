...
Cluster rationale: ${cluster.rationale || '(none)'}

Generate ONE content brief that targets this whole cluster — the primary keyword as the H1 / focus, the secondaries woven in as sub-topics, sub-headings, or natural references.
