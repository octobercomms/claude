...
require_once HGD_PATH . 'includes/class-hgd-log.php';
require_once HGD_PATH . 'includes/class-hgd-rate-limit.php';
...
require_once HGD_PATH . 'includes/class-hgd-flux.php';
require_once HGD_PATH . 'includes/class-hgd-maps.php';
require_once HGD_PATH . 'includes/class-hgd-woo.php';
require_once HGD_PATH . 'includes/class-hgd-measure.php';
...
require_once HGD_PATH . 'includes/class-hgd-subscription-page.php';
...
// WooCommerce bridge (consultation product + checkout/receipts).
add_action( 'plugins_loaded', function () {
	HGD_Woo::init();
}, 20 );
