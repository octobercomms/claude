...
const styles = {
  ...
  newCard: { background: 'white', border: '2px solid #1a1a1a', borderRadius: 14, padding: 24, marginBottom: 24 },
  form: { display: 'flex', flexDirection: 'column', gap: 16 },
  row: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 },
  field: { display: 'flex', flexDirection: 'column', gap: 6 },
  label: { fontSize: 11, fontWeight: 600, color: '#888', textTransform: 'uppercase', letterSpacing: 1.2 },
  input: { padding: '10px 12px', border: '2px solid #1a1a1a', borderRadius: 8, fontSize: 14, fontFamily: 'inherit', background: '#fff' },
