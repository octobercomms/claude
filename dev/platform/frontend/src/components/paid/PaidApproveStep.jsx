    ...
    >
      {!activeBatch ? (
        ...
        <>
          ...
          {shareUrl && (
            <div style={{ background: 'var(--positive-soft)', border: '1px solid #2e7d32', padding: 'var(--s3) var(--s4)', borderRadius: 'var(--r-sm)', marginTop: 'var(--s4)', display: 'flex', alignItems: 'center', gap: 'var(--s3)' }}>
