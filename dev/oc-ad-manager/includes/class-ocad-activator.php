	...
	public static function activate() {
		...
		$sql = "
			...
			CREATE TABLE {$bookings_table} (
				...
				end_date date DEFAULT NULL,
				image_attachment_id_lb bigint(20) unsigned DEFAULT NULL,
				image_attachment_id_sky bigint(20) unsigned DEFAULT NULL,
				stripe_payment_intent_id varchar(500) DEFAULT NULL,
				package_name varchar(255) NOT NULL DEFAULT '',
				package_type varchar(20) NOT NULL DEFAULT 'impressions',
				package_quantity bigint(20) NOT NULL DEFAULT 0,
