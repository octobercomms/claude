 ...
 *
 * Everything else is registered fresh here with an `oe_` slug so it can never
...
final class PostTypes {
     ...
     */
    public const TYPES = [
        'directory'   => ['slug' => 'oe_directory',   'external' => false, 'listing' => true,  'label' => 'Directory'],
        'destination' => ['slug' => 'oe_destination', 'external' => false, 'listing' => true,  'label' => 'Destination'],
        'product'     => ['slug' => 'oe_product',     'external' => false, 'listing' => true,  'label' => 'Product'],
        'event'       => ['slug' => 'events',          'external' => true,  'listing' => true,  'label' => 'Event'],
        'story'       => ['slug' => 'oe_story',       'external' => false, 'listing' => true,  'label' => 'Story'],
        ...
        // Tickets/orders are relational tables (see OE\Ticketing), not a CPT.
        'account'     => ['slug' => 'oe_account',     'external' => false, 'listing' => false, 'label' => 'Account'],
    ...
    private function args(string $singular, string $plural, string $icon, array $supports, bool $public = true): array {
        return [
            ...
            'supports'            => $supports,
            'menu_icon'           => $icon,
            'rewrite'             => $public ? ['slug' => 'oe-' . sanitize_title($plural)] : false,
        ];
    }
}
