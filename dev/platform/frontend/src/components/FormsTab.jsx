...
function Kpi({ label, value, accent = false }) {
  return (
    <div style={{ padding: '12px 14px', border: 'var(--border-w) solid var(--accent)', borderRadius: 'var(--r-sm)', background: accent ? 'var(--warning-soft)' : 'var(--surface-raised)' }}>
...
const cardStyle = { background: 'white', border: 'var(--border-w) solid var(--accent)', borderRadius: 'var(--r-sm)', padding: 20 };
const dateInputStyle = { padding: '5px 8px', border: 'var(--border-w) solid var(--accent)', borderRadius: 'var(--r-sm)', fontSize: 12 };
...
const btnSmStyle = { background: 'var(--surface)', color: 'var(--text)', border: 'var(--border-w) solid var(--accent)', borderRadius: 'var(--r-pill)', padding: '6px 14px', fontSize: 12, cursor: 'pointer', fontWeight: 600 };
